...
```{r}
library(ggplot2)
ggplot(data=mnew, aes(x=friend_mention, y=count, group=friend_mention, color=friend_mention, fill=friend_mention, label=count)) + 
  scale_fill_brewer(palette = "Set3") + 
  scale_color_brewer(palette = "Set3") +
  geom_bar(stat="identity")+
  ...
  labs(x="", y="")+
  ggtitle("The One With All The Quantifiable Friendships", subtitle="Mentions of and by the Friends")
```
```{r}
